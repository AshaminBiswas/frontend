  ...
  return (
    <section className="py-12 px-4 md:px-8 lg:px-16">
      <div className="flex items-center justify-between mb-8">
        ...
        {/* Clicking View All navigates directly to /new-arrivals */}
        <Link
          to="/new-arrivals"
      ...
      <div className="relative group/section">
        ...
        <button
          type="button"
          onClick={() => scroll(-1)}
          aria-label="Previous Value For Money Product"
        ...
        <button
          type="button"
          onClick={() => scroll(1)}
          aria-label="Next Value For Money Product"
