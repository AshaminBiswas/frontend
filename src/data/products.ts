...
export const AESTHETIC_SECTION_1 = [
  { id: '1', title: 'Glass Door Fittings', subtitle: 'Satin & Polished SS 304', image: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=600&q=80', link: '/category/glass-fittings' },
  { id: '2', title: 'Toilet Cubicle Hardware', subtitle: 'Restroom Hardware Kits', image: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=600&q=80', link: '/category/cubicles-hardware' },
  { id: '3', title: 'Electronic Locker Locks', subtitle: 'Keypad & RFID Locks', image: 'https://images.unsplash.com/photo-1558002038-1055907df827?auto=format&fit=crop&w=600&q=80', link: '/category/locker-hardware' }
];
